...
@export var default_defence: float = 0.0
...
func _ready() -> void:
	...
	stats[Global.STATS_NAMES["DEFENCE"]] = Stat.new(default_defence)
...
func set_defence(value: float):
	_set_stat(Global.STATS_NAMES["DEFENCE"], value)
